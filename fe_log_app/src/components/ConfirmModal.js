...
class ConfirmModal extends React.Component {
  ...
  render() {
    var cancelButton = this.props.showCancelButton ? (
      <Button variant={this.props.cancelBsVariant} onClick={this.onClose}>
    ...
    var modal = (
      ...
      >
        ...
        <Modal.Footer>
          {cancelButton}
          <Button
            variant={this.props.confirmBsVariant}
...
ConfirmModal.propTypes = {
  ...
  confirmBsVariant: PropTypes.string,
  cancelBsVariant: PropTypes.string,
...
ConfirmModal.defaultProps = {
  cancelText: "Cancel",
  confirmText: "Confirm",
  confirmBsVariant: "primary",
  cancelBsVariant: "secondary",
